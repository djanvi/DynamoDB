...
public class SimpleDynamoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button4).setOnClickListener(new lDumpClickListener(tv,getContentResolver()));
        findViewById(R.id.button5).setOnClickListener(new getClickListener(tv,getContentResolver()));
	}
